...
return this.getAtomChiralityLimited (a.atom, a, Clazz.innerTypeInstance (JS.CIPChirality.CIPAtom, this, null).create (pa, null, false, true), ruleMax) - 1;
...
}, "JU.SimpleNode,JS.CIPChirality.CIPAtom,~B,~B");
...
JU.Logger.info ("---");
}var f = (this.rule4List != null && this.b$["JS.CIPChirality"].currentRule > 5);
for (var g = 0; g < 4; g++) {
var h = this.atoms[g];
for (var i = g + 1; i < 4; i++) {
var j = this.atoms[i];
...
for (var k = 0; k < 4; k++) {
var l = b[k];
var m = h[l] = this.atoms[k];
i[l] = this.priorities[k];
if (m.atom != null) j.set (this.priorities[k]);
}
this.atoms = h;
this.priorities = i;
this.nPriorities = j.cardinality ();
if (this.ties != null) {
...
for (var l = 0; l < 4; l++) {
JU.Logger.info (this.dots () + this.myPath + "[" + l + "]=" + this.atoms[l] + " " + this.priorities[l] + " " + Integer.toHexString (this.priorities[l]) + " new");
}
...
Clazz.defineMethod (c$, "breakTie", 
 function (a, b) {
if (this.atomIndex == 1 && a.atomIndex == 3) if (JU.Logger.debugging && this.isHeavy () && a.isHeavy ()) JU.Logger.info (this.dots () + "tie for " + this + " and " + a + " at sphere " + b);
...
var i = Math.abs (h);
if (i < d) {
if (JU.Logger.debugging && f.isHeavy () && g.isHeavy ()) JU.Logger.info (f.dots () + "compareDeep sub " + f + " " + g + ": " + h + "/" + c);
d = i;
c = h;
}}
...
f = c.get (h);
e = (f == null ? Clazz.innerTypeInstance (JS.CIPChirality.CIPAtom, this, null).create (null, this, true, this.isAlkene) : f.clone ());
e.sphere = d.sphere + 1;
...
var e;
e = this.clone ();
e.atoms[c] = Clazz.innerTypeInstance (JS.CIPChirality.CIPAtom, this, null).create (null, e, false, false);
e.atoms[d] = Clazz.innerTypeInstance (JS.CIPChirality.CIPAtom, this, null).create (null, e, false, false);
