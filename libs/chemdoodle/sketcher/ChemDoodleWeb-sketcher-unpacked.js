//
// ChemDoodle Web Components 4.3.0
//
...
(function(desktop, q, document) {
	...
	desktop.DropDown.prototype.getHiddenSource = function() {
		var sb = [];
		sb.push('<div style="display:none;position:absolute;border:1px #C1C1C1 solid;background:#F5F5F5;padding:5px;border-bottom-left-radius:5px;-moz-border-radius-bottomleft:5px;border-bottom-right-radius:5px;-moz-border-radius-bottomright:5px;" id="');
		sb.push(this.id);
		sb.push('_hidden">');
...
(function(c, iChemLabs, io, actions, gui, desktop, structures, q, document) {
	...
	gui.ToolbarManager.prototype.makeBondSet = function(self) {
		...
		this.buttonSingle = new desktop.DummyButton('button_bond', self.sketcher.iconPath, 'SingleBond', 'Single Bond', function() {
		...
		this.bondSet.addDropDown('Autres liaisons', self.sketcher.iconPath);
		this.bondSet.dropDown.buttonSet.buttons.push(new desktop.Button('button_bond_single', self.sketcher.iconPath, 'SingleBond', 'Single Bond', function() {
			self.sketcher.stateManager.currentState = self.sketcher.stateManager.STATE_NEW_BOND;
			self.sketcher.stateManager.STATE_NEW_BOND.bondOrder = 1;
			self.sketcher.stateManager.STATE_NEW_BOND.stereo = structures.Bond.STEREO_NONE;
		}));
		this.bondSet.dropDown.buttonSet.buttons.push(new desktop.Button('button_bond_recessed', self.sketcher.iconPath, 'RecessedBond', 'Recessed Bond', function() {
			self.sketcher.stateManager.currentState = self.sketcher.stateManager.STATE_NEW_BOND;
			self.sketcher.stateManager.STATE_NEW_BOND.bondOrder = 1;
			self.sketcher.stateManager.STATE_NEW_BOND.stereo = structures.Bond.STEREO_RECESSED;
		}));
		this.bondSet.dropDown.buttonSet.buttons.push(new desktop.Button('button_bond_protruding', self.sketcher.iconPath, 'ProtrudingBond', 'Protruding Bond', function() {
			self.sketcher.stateManager.currentState = self.sketcher.stateManager.STATE_NEW_BOND;
			self.sketcher.stateManager.STATE_NEW_BOND.bondOrder = 1;
			self.sketcher.stateManager.STATE_NEW_BOND.stereo = structures.Bond.STEREO_PROTRUDING;
		}));
		this.bondSet.dropDown.buttonSet.buttons.push(new desktop.Button('button_bond_double', self.sketcher.iconPath, 'DoubleBond', 'Double Bond', function() {
			self.sketcher.stateManager.currentState = self.sketcher.stateManager.STATE_NEW_BOND;
		...
		this.bondSet.dropDown.defaultButton = this.bondSet.dropDown.buttonSet.buttons[0];
	...
	gui.ToolbarManager.prototype.makeRingSet = function(self) {
		...
		this.buttonCyclohexane = new desktop.DummyButton('button_ring', self.sketcher.iconPath, 'Cyclohexane', 'Cyclohexane Ring', function() {
		...
		this.ringSet.addDropDown('Autres cycles', self.sketcher.iconPath);
		this.ringSet.dropDown.buttonSet.buttons.push(new desktop.Button('button_ring_cyclopropane', self.sketcher.iconPath, 'Cyclopropane', 'Cyclopropane Ring', function() {
			self.sketcher.stateManager.currentState = self.sketcher.stateManager.STATE_NEW_RING;
		...
		this.ringSet.dropDown.buttonSet.buttons.push(new desktop.Button('button_ring_cyclohexane', self.sketcher.iconPath, 'Cyclohexane', 'Cyclohexane Ring', function() {
			self.sketcher.stateManager.currentState = self.sketcher.stateManager.STATE_NEW_RING;
			self.sketcher.stateManager.STATE_NEW_RING.numSides = 6;
			self.sketcher.stateManager.STATE_NEW_RING.unsaturated = false;
		}));
		this.ringSet.dropDown.buttonSet.buttons.push(new desktop.Button('button_ring_benzene', self.sketcher.iconPath, 'Benzene', 'Benzene Ring', function() {
			self.sketcher.stateManager.currentState = self.sketcher.stateManager.STATE_NEW_RING;
			self.sketcher.stateManager.STATE_NEW_RING.numSides = 6;
		...
		this.ringSet.dropDown.defaultButton = this.ringSet.dropDown.buttonSet.buttons[3];
